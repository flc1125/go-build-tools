...
func TestGetDependencies(t *testing.T) {
	...
	tmpRootDir := t.TempDir()
	modFiles := map[string][]byte{
		filepath.Join(tmpRootDir, "test", "test1", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test3 v0.1.0\n" +
			")"),
		filepath.Join(tmpRootDir, "test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test3\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\n" +
			")"),
		filepath.Join(tmpRootDir, "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/testroot\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test3 v0.1.0\n" +
			")"),
		filepath.Join(tmpRootDir, "test", "test2", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test3 v0.1.0\n\t" +
			"github.com/flc1125/go-build-tools/multimod/internal/verify/testroot v0.2.0\n" +
			")"),
	}
	...
	expected := dependencyMap{
		"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1": []shared.ModulePath{
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2",
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test3",
		},
		"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2": []shared.ModulePath{
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1",
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test3",
			"github.com/flc1125/go-build-tools/multimod/internal/verify/testroot",
		},
		"github.com/flc1125/go-build-tools/multimod/internal/verify/test3": []shared.ModulePath{
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1",
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2",
		},
		"github.com/flc1125/go-build-tools/multimod/internal/verify/testroot": []shared.ModulePath{
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1",
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2",
			"github.com/flc1125/go-build-tools/multimod/internal/verify/test3",
		},
...
func TestVerifyDependencies(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			repoRoot:           filepath.Join(tmpRootDir, "valid"),
			modFiles: map[string][]byte{
				filepath.Join(tmpRootDir, "valid", "test", "test1", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n" +
					")"),
				filepath.Join(tmpRootDir, "valid", "test", "test2", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n" +
					")"),
				filepath.Join(tmpRootDir, "valid", "test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test3\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\n" +
					")"),
				filepath.Join(tmpRootDir, "valid", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/testroot\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\t" +
		...
		},
		{
			...
			modFiles: map[string][]byte{
				filepath.Join(tmpRootDir, "stable_unstable", "test", "test1", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test3 v0.1.0\n" +
					")"),
				filepath.Join(tmpRootDir, "stable_unstable", "test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test3\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\n" +
					")"),
				filepath.Join(tmpRootDir, "stable_unstable", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/testroot\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test3 v0.1.0\n" +
					")"),
				filepath.Join(tmpRootDir, "stable_unstable", "test", "test2", "go.mod"): []byte("module github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/multimod/internal/verify/test3 v0.1.0\n\t" +
			...
			expectedLogs: []string{
				(&errDependency{
					modPath:    "github.com/flc1125/go-build-tools/multimod/internal/verify/test/test1",
					modVersion: "v1.2.3-RC1+meta",
					depPath:    "github.com/flc1125/go-build-tools/multimod/internal/verify/test3",
					depVersion: "v0.1.0",
				}).Error(),
				(&errDependency{
					modPath:    "github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2",
					modVersion: "v1.2.3-RC1+meta",
					depPath:    "github.com/flc1125/go-build-tools/multimod/internal/verify/testroot",
					depVersion: "v0.2.0",
				}).Error(),
				(&errDependency{
					modPath:    "github.com/flc1125/go-build-tools/multimod/internal/verify/test/test2",
