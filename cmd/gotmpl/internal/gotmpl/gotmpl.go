...
// Package gotmpl renders Go templates using JSON data.
package gotmpl
...
// Run uses [text/template] package to generate a file using
// bodyPath as template body filepath,
// jsonData as data in JSON format,
// outPath as output filepath.
func Run(bodyPath, jsonData, outPath string) error {
	if bodyPath == "" {
