	...
	}{
		{
			...
			expected: map[string][]byte{
				"go.mod": []byte("module github.com/flc1125/go-build-tools/cmd/crosslink/testroot\n\n" +
					...
					"replace github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testY => ./testY\n\n" +
					"replace github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testZ => ./testZ\n\n" +
		...
		},
		{
			...
			expected: map[string][]byte{
				...
				filepath.Join("testA", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testA\n\n" +
					...
					")\n" +
					"replace github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testB => ../testB\n\n" +
					"replace github.com/flc1125/go-build-tools/cmd/crosslink/testroot => ../"),
	...
	for _, test := range tests {
		t.Run(test.testCase, func(t *testing.T) {
			...
			modFilesExpected := map[string][]byte{
				filepath.Join(tmpRootDir, "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/crosslink/testroot\n\n" +
					"go 1.20\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testA v1.0.0\n" +
					")\n" +
				...
				filepath.Join(tmpRootDir, "testA", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testA\n\n" +
					"go 1.20\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testB v1.0.0\n" +
					")\n" +
					"replace github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testB => ../testB"),
				filepath.Join(tmpRootDir, "testB", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testB\n\n" +
					"go 1.20\n\n"),
			}
