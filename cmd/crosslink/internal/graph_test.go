...
func TestBuildDependencyGraph(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: map[string][]string{
				"github.com/flc1125/go-build-tools/cmd/crosslink/testroot": {
				...
				"github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testA": {"github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testB"},
				"github.com/flc1125/go-build-tools/cmd/crosslink/testroot/testB": {},
			},
		},
		{
