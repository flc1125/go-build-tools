...
import (
	...
	"github.com/flc1125/go-build-tools/cmd/crosslink/internal/syncerror"
...
func init() {
	...
	comCfg.workCommand.Flags().StringSliceVar(&comCfg.skipFlags, "skip", []string{}, "list of comma separated go.mod files that will be ignored when updating go.work. "+
		"multiple calls of --skip can be made")
