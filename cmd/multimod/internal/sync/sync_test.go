...
func TestNewSync(t *testing.T) {
	...
	modFiles := map[string][]byte{
		filepath.Join(tmpRootDir, "my", "test", "test1", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2 v1.2.3-RC1+meta\n\t" +
			"go.opentelemetry.io/other/test/test1 v1.0.0-old\n\t" +
			"go.opentelemetry.io/other/testroot/v2 v2.2.2\n" +
			")"),
		filepath.Join(tmpRootDir, "my", "test", "test2", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.2.3-RC1+meta\n\t" +
			"go.opentelemetry.io/other/test/test1 v1.0.0-old\n\t" +
			"go.opentelemetry.io/other/testroot/v2 v2.2.2\n" +
			")"),
		filepath.Join(tmpRootDir, "my", "test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test3\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2 v1.2.3-RC1+meta\n\t" +
			...
			")"),
		filepath.Join(tmpRootDir, "my", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/testroot/v2\n\n" +
			"go 1.16\n\n" +
			"require (\n\t" +
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.2.3-RC1+meta\n\t" +
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2 v1.2.3-RC1+meta\n" +
		...
		ModSetMap: shared.ModuleSetMap{
			"my-mod-set-1": shared.ModuleSet{
				...
				Modules: []shared.ModulePath{
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1",
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2",
				},
			},
			"my-mod-set-2": shared.ModuleSet{
				Version: "v0.1.0",
				Modules: []shared.ModulePath{
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test3",
				},
			},
			"my-mod-set-3": shared.ModuleSet{
				Version: "v2.2.2",
				Modules: []shared.ModulePath{
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/testroot/v2",
				},
			},
		},
		ModPathMap: shared.ModulePathMap{
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1":  shared.ModuleFilePath(filepath.Join(tmpRootDir, "my", "test", "test1", "go.mod")),
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2":  shared.ModuleFilePath(filepath.Join(tmpRootDir, "my", "test", "test2", "go.mod")),
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test3":       shared.ModuleFilePath(filepath.Join(tmpRootDir, "my", "test", "go.mod")),
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/testroot/v2": shared.ModuleFilePath(filepath.Join(tmpRootDir, "my", "go.mod")),
		},
		ModInfoMap: shared.ModuleInfoMap{
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1": shared.ModuleInfo{
				ModuleSetName: "my-mod-set-1",
				Version:       "v1.2.3-RC1+meta",
			},
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2": shared.ModuleInfo{
				ModuleSetName: "my-mod-set-1",
				Version:       "v1.2.3-RC1+meta",
			},
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test3": shared.ModuleInfo{
				ModuleSetName: "my-mod-set-2",
				Version:       "v0.1.0",
			},
			"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/testroot/v2": shared.ModuleInfo{
...
func TestUpdateAllGoModFilesWithCommitHash(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			modSetName: "other-mod-set-1",
			expectedOutputModFiles: map[string][]byte{
				filepath.Join("my", "test", "test1", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2 v1.2.3-RC1+meta\n\t" +
					...
					"go.opentelemetry.io/other/testroot/v2 v2.2.2\n" +
					")"),
				filepath.Join("my", "test", "test2", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.2.3-RC1+meta\n\t" +
					"go.opentelemetry.io/other/test/test1 v1.2.4-RC1+meta\n\t" +
					"go.opentelemetry.io/other/testroot/v2 v2.2.2\n" +
					")"),
				filepath.Join("my", "test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test3\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2 v1.2.3-RC1+meta\n\t" +
					"go.opentelemetry.io/other/test2 v0.1.0-old\n" +
					")"),
				filepath.Join("my", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/testroot/v2\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test2 v1.2.3-RC1+meta\n\t" +
	...
	}{
		{
			...
			expectedOutputModFiles: map[string][]byte{
				...
				filepath.Join("my", "test", "testexcluded", "go.mod"): []byte("module go.opentelemetry.io/my/test/testexcluded\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync/test/test1 v1.0.0-old\n\t" +
