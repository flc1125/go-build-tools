...
import (
	...
	"github.com/flc1125/go-build-tools/cmd/multimod/internal/sync"
)
...
- Adds and commits changes to Git branch`,
	...
	RunE: func(cmd *cobra.Command, _ []string) error {
		...
		return sync.Run(cmd.Context(), versioningFile, otherVersioningFile, otherRepoRoot, moduleSetNamesSync, otherVersionCommit, allModuleSetsSync, skipGoModTidySync)
	},
}
