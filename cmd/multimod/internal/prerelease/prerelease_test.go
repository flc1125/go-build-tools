...
func TestUpdateAllGoModFiles(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			modSetName: "mod-set-1",
			expectedOutputModFiles: map[string][]byte{
				filepath.Join("test", "test1", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test1\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					...
					")"),
				filepath.Join("test", "test2", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test2\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					...
					"go.opentelemetry.io/other/testroot/v2 v2.2.2\n" +
					")"),
				filepath.Join("test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test3\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test2 v1.2.3-RC1+meta\n\t" +
					...
					")"),
				"go.mod": []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/testroot\n\n" +
					"go 1.16\n\n" +
					"require (\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test1 v1.2.3-RC1+meta\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test2 v1.2.3-RC1+meta\n\t" +
		...
		},
		{
			...
			expectedOutputModFiles: map[string][]byte{
				...
				"go.mod": []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/testroot\n\n" +
					...
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test1 v1.2.3-OLD\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test2 v1.2.3-OLD\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test3 v0.1.0\n\t" +
					"go.opentelemetry.io/other/test/test1 v1.0.0\n\t" +
					")"),
				filepath.Join("excluded", "go.mod"): []byte("module go.opentelemetry.io/my/test/testexcluded\n\n" +
					"go 1.16\n\n" +
		...
		},
		{
			...
			expectedOutputModFiles: map[string][]byte{
				...
				filepath.Join("test", "go.mod"): []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test3\n\n" +
					...
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test1 v1.2.3-OLD\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/test/test2 v1.2.3-OLD\n\t" +
					"github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/testroot v0.2.0\n\t" +
					"go.opentelemetry.io/other/test2 v0.1.0\n" +
					")"),
				"go.mod": []byte("module github.com/flc1125/go-build-tools/cmd/multimod/internal/prerelease/testroot\n\n" +
					"go 1.16\n\n" +
